# Episode Brief: coil-kt/coil #2779
...
- Focus language: Kotlin/Compose
- Repository: [coil-kt/coil](https://github.com/coil-kt/coil)
- Issue: [#2779 — Placeholder image messes up image `ContentScale`](https://github.com/coil-kt/coil/issues/2779)
- Stars at research time: 11,827
- Labels: help wanted
- Fit confidence: high
...
- Popular repository: 11,827 stars.
- Issue has 1334 characters of report detail and 3 comments.
- Clear video angle: Placeholder image changes AsyncImage ContentScale behavior.
- Labels indicate: help wanted.
