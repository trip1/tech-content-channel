# Episode Brief: kubernetes/minikube #23163
...
- Focus language: Go
- Repository: [kubernetes/minikube](https://github.com/kubernetes/minikube)
- Issue: [#23163 — Flaky test: TestDownloadOnly preload tarball missing on Docker](https://github.com/kubernetes/minikube/issues/23163)
- Stars at research time: 31,894
...
- Popular repository: 31,894 stars.
- Issue has 1825 characters of report detail and 0 comments.
- Clear video angle: Flaky TestDownloadOnly preload tarball missing on Docker.
- Labels indicate: area/testing, needs-triage.
