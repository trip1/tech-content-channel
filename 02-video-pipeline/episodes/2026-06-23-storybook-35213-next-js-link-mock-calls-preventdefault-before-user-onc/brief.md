# Episode Brief: storybookjs/storybook #35213
...
- Focus language: React/TypeScript
- Repository: [storybookjs/storybook](https://github.com/storybookjs/storybook)
- Issue: [#35213 — [Bug]: @storybook/nextjs-vite next/link mock calls preventDefault before onClick](https://github.com/storybookjs/storybook/issues/35213)
- Stars at research time: 90,416
...
- Popular repository: 90,416 stars.
- Issue has 2554 characters of report detail and 1 comments.
- Clear video angle: Next.js Link mock calls preventDefault before user onClick.
- Labels indicate: bug, nextjs, needs triage.
