# Episode Brief: eslint/eslint #20987
...
- Focus language: JavaScript
- Repository: [eslint/eslint](https://github.com/eslint/eslint)
- Issue: [#20987 — Bug: Autofix for prefer-exponentiation-operator produces SyntaxError when Math.pow() is at the start of an ExpressionStatement](https://github.com/eslint/eslint/issues/20987)
- Stars at research time: 27,389
...
- Popular repository: 27,389 stars.
- Issue has 2044 characters of report detail and 5 comments.
- Clear video angle: prefer-exponentiation-operator autofix can generate SyntaxError.
- Labels indicate: bug, rule, accepted, autofix.
