# Episode Brief: detekt/detekt #9279
...
- Focus language: Kotlin
- Repository: [detekt/detekt](https://github.com/detekt/detekt)
- Issue: [#9279 — Allow configuring UnnecessaryFullyQualifiedName to ignore certain packages](https://github.com/detekt/detekt/issues/9279)
- Stars at research time: 6,979
...
- Popular repository: 6,979 stars.
- Issue has 319 characters of report detail and 19 comments.
- Clear video angle: Allow UnnecessaryFullyQualifiedName ignore packages.
- Labels indicate: help wanted, feature, good first issue.
